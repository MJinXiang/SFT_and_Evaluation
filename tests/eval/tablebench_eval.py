...
def save_results(em_score, details, qtype_em_scores, output_file: str, results_file: str):
    """
...
def main():
    ...
    save_results(em_score, details, qtype_em_scores, args.output_file, args.results_file)
