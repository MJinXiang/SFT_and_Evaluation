...
def save_results(bleu_score: float, details: List[Dict], output_file: str):
    ...
    #     f.write("ToTTo Evaluation Report\n")
    #     f.write("=" * 40 + "\n")
    #     f.write(f"Average BLEU Score: {bleu_score * 100:.2f}%\n")
    #     f.write(f"Minimum BLEU Score: {statistics['min_bleu'] * 100:.2f}%\n")
    #     f.write(f"Maximum BLEU Score: {statistics['max_bleu'] * 100:.2f}%\n")
    #     f.write(f"Median BLEU Score: {statistics['median_bleu'] * 100:.2f}%\n")
    #     f.write(f"Standard Deviation: {statistics['std_bleu'] * 100:.2f}%\n")
    #     f.write(f"Total Examples: {statistics['total_examples']}\n")
    #     f.write("=" * 40 + "\n")
