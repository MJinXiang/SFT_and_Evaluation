            ...
            if remain_codes:
                ...
                for k in range(len(remain_prompts)):
                    ...
                    if model_responses[i].count("```python")>=2:
                        message =  "\nYou have exceeded the maximum number of Python code usage attempts. Please think step-by-step and give me the final answer directly. You are not allowed to use ```python. Do NOT use ```python.\n\n"
                        query += message
